...
- 💼 13+ years in IT Infrastructure & Systems Engineering
- ☁️ Currently focused on Azure Cloud & DevOps Engineering
- 🐧 Learning and building with Linux, Docker, CI/CD & Automation
- 🏗️ Interested in scalable SaaS architectures & cloud-native systems
- 🔧 Background in Microsoft Infrastructure, Active Directory & Enterprise Systems
...
### 🏫 School Management & Booking Platform
Production-ready booking and scheduling system built with:
...
### ☁️ SaaS Migration Architecture
Migration plan from Google Workspace stack to:
- Supabase
- Edge Functions
- Modern frontend hosting
- Scalable free-tier infrastructure

### 🔐 Infrastructure Automation
Scripts & automation for:
- User management
